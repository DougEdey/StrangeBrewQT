...
qtfontsdir=/home/doug/qt5/qtbase/lib/fonts
...
qtplatformplugin=/home/doug/qt5/qtbase/plugins/platforms/libqxcb.so
...
# requires.
qtsqliteplugin=/home/doug/qt5/qtbase/plugins/sqldrivers/libqsqlite.so
...
echo "Copying data and recipes"
cp -R data $tardir/data
cp -R Recipes $tardir/Recipes
